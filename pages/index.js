...
const projects = [
  ...
  },
  {
    ...
    stack: ["React", "Rest api", "tailwind"],
    link: "https://nft-collection-theme.vercel.app/",
    repo: "https://github.com/divyansh343/nft-collection-theme",
    isSiteLive: true,
  },
  {
    title: "Hangout pallete",
    overview:
      "A single-page application that helps developers or designer to find right colour for thier website.",
    stack: ["React", "css"],
    link: "https://hangouts-pallete.vercel.app/",
    repo: "https://github.com/divyansh343/hangouts-pallete",
    isSiteLive: true,
  },
  {
  ...
  },
  {
    title: "portfolio",
    overview:
      "this is my portfolio you currently surfing on",
    stack: ["next js", "tailwind"],
    link: "https://divyanshpal.vercel.app/",
    repo: "https://github.com/divyansh343/portfolio",
    isSiteLive: true,
  },
  {
    title: "All projects",
    overview:
      "look into my github repositorys to dig more into my profile",
    stack: ["github"],
    link: "https://github.com/divyansh343/",
    repo: false,
    isSiteLive: true,
  },
];
...
export default function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>Divyansh Pal | Frontend Developer  </title>
        <meta
          name="description"
          ...
          <div className="container relative flex flex-col items-start justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section">
            <div className="w-full">
              ...
              <p className="w-4/5 text-xl md:w-full">
                Making imagination come alive on the internet.
              </p>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col-reverse items-start w-full md:flex-row">
              <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                ...
                <p className="text-lg">
                  Alongside my design and development work, I love to work on project that are useful sometime to release dopamine.
                </p>
                <p className="text-lg">
        ...
        >
          ...
          <div className="flex flex-col w-full mb-12">
            ...
            <FeaturedProjectCard
              title={"theglu"}
              status={"Recent"}
              description={`Powered by Sanity Content management system, it is a two-dimensional free platform. This makes it simple to concentrate on producing top-notch content rather than managing. Because of the strength of server side rendering, the frontend is on Next js, which helps with improved SEO, which is vital for a blogging platform.`}
              float={`right-0`}
              flexDirection={`flex-col lg:flex-row-reverse`}
              imgWidth={"1366"}
              imgHeight={"666"}
            ...
            <FeaturedProjectCard
              title={"Rocktwrite"}
              status={"Recent"}
              description={`Rocktwrite is an AI writing tool. It is able to create stories and write letters. You can ask for anything to be written in writing. It is also capable of writing code. The Davinci Model and Codex feature of Open AI serve as its foundation.`}
              float={`right-0`}
              flexDirection={`flex-col lg:flex-row-reverse`}
              imgWidth={"1200"}
              imgHeight={"666"}
              imgSrc={"/projects/rock.png"}
              liveLink={"https://rocktwrite.theglu.in"}
              repoLink={null}
              stack={
                <>
                 <Icon
            ...
            <FeaturedProjectCard
              title={"pahalindia"}
              status={"Recent"}
              description={`Pahal india multipurpose nidhi limited is a cooperrative bank in chhindwara built in HTML, CSS & JavaScript`}
              float={`right-0`}
              flexDirection={`flex-col lg:flex-row-reverse`}
              imgWidth={"1366"}
              imgHeight={"666"}
